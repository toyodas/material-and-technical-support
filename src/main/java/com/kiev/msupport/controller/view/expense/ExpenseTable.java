...
public class ExpenseTable {
    ...
    public ExpenseTable(String category, String name, String units, String dep, String amount) {
    ...
    public ExpenseTable(CategoryEntity category, String name, UnitEntity units, DepartmentEntity dep, String amount, String price) {
